                    ...
                    (datas !== undefined) ?
                        ...
                        (
                            <section>
                                ...
                                <p className={styles.text}>
                                    Of creative and determined nature, I remain updated through social networks, online workshops, and digital content on the trends and innovations in the industry. With a courteous relationship, I keep great contact and interaction with different suppliers and professionals of the sector. When it comes to lighting design, my experience includes a differential of technical characteristics with the correct application of light and its specifications, creating a harmonious environment with a unique characteristic, a personal signature.
                                </p>
                                <p className={styles.text}>
